...
RMDIR /s /q C:\Users\Public\Projects\NewWorldLife\cache
echo.
echo Dossier cache supprime !
echo.
echo Lancement de votre serveur FiveM en cours...
echo.
cd C:\Users\Public\Projects\NewWorldLife
C:\Users\Public\Projects\NewWorldLife\FXServer.exe +exec server.cfg
echo.
...
XCOPY C:\Users\Public\Projects\NewWorldLife C:\Users\Public\Projects\NewWorldLife_backup /m /e /y
echo.
